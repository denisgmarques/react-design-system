...
export function SignIn() {
  ...
  async function handleSignIn(event: FormEvent) {
    ...
    await axios.post('/sessions', {
      email: 'denisgmarques@hotmail.com',
      password: '1234567890'
    })
  ...
  return (
    ...
    <form onSubmit={handleSignIn} className='flex flex-col items-stretch w-full max-w-sm'>
      {isUserSignedIn && <Text>Login realizado!</Text>}
      <label htmlFor='email' className='flex flex-col gap-3 mt-8'>
